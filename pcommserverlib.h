/****************************************************************************
**
** Namespace PCOMMSERVERLib generated by dumpcpp v5.9.0 using
...
public:
    ...
    : QAxWidget(parent, f)
    {
        setControl("{b544d2bd-354c-456e-9e88-20f71625e7df}");
    }
...
public:
    ...
    : QAxWidget(parent, f)
    {
        setControl("{450149a8-e6b7-4563-8038-fbcad025d056}");
    }
